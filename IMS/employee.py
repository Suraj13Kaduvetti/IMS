...
class employeeClass:
    def __init__(self,root):
        ...
        self.txt_address.place(x=150,y=270,width=300,height=80)
        ...
        self.EmployeeTable.column("address",width=400)
...
#===============================================================================
    ...
    def add(self):
        ...
        cur=con.cursor()
        try:
            if self.var_emp_id.get()=="": #or self.var_name.get()=="" or self.var_email.get()=="" or self.var_gender.get()=="" or self.var_contact.get()=="" or self.var_dob.get()=="" or self.var_doj.get()=="" or self.var_pass.get()=="" or self.var_utype.get()=="" or self.var_address.get()=="" or self.var_salary.get()=="":
