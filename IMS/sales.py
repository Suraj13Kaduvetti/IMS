...
#===========================================
        ...
        txt_invoice=Entry(self.root,textvariable=self.var_invoice,font=("times new roman",15),bg="lightyellow",fg="black").place(x=160,y=100,width=180,height=28)
        ...
        self.Sales_List=Listbox(sales_Frame,font=("goudy old styyle",15),bg="white",yscrollcommand=scrolly.set)
        ...
        lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("times new roman",25,"bold"),bg="lightgreen",fg="navy").pack(side=TOP,fill=X)

        scrolly2=Scrollbar(bill_Frame,orient=VERTICAL)
        self.bill_area=Text(bill_Frame,bg="lightyellow",yscrollcommand=scrolly2.set) #,font=("goudy old style",15)
...
#=========================================================
    ...
    def search(self):
        if self.var_invoice.get()=="":
            messagebox.showerror("Error","Invoice No. sholud be required",parent=self.root)
        else:
